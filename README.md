...
Herald is a self-contained Claude Skill. For a quick setup, copy [`skill/`](/skill/) folder into a Claude skills directory and name the copy `herald` there to install it as a skill.
